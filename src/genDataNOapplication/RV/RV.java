...
//******************************************************************** */
//Funciï¿½n que lee los datos de casos del fichero "nomFixter" y los     */
		...
		int user2, int num_values)
{
		...
		Object[] data=null;
		int i, j, k;
		//num_values es el nï¿½mero de variables, num_cases es el nï¿½mero de casos
		data  = new Object[4+1];
		String valVar;
			...
			try{
				...
				else
				{
					...
					if(configuration.getMode()=="sv") {
						...
						genPublicationsDV.main(null, configuration); //Versión dinámica
					}
					//FIN STEP 4 PAU
