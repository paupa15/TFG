   ...
   public static boolean loadConfig(File file, ConfigurationModel configuration) {
	   ...
	   try {
		   ...
		   DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
    		 ...
    		 System.out.println("InputFile3: " + eElement.getElementsByTagName("inputFile3").item(0).getTextContent());
    		 configuration.setInputFile3(eElement.getElementsByTagName("inputFile3").item(0).getTextContent());
	         ...
	         configuration.setDin1(outFilesElem.getElementsByTagName("din1").item(0).getTextContent());
	         configuration.setDin2(outFilesElem.getElementsByTagName("din2").item(0).getTextContent());
	         configuration.setDin3(outFilesElem.getElementsByTagName("din3").item(0).getTextContent());
	         configuration.setDin4(outFilesElem.getElementsByTagName("din4").item(0).getTextContent());
	         configuration.setDin5(outFilesElem.getElementsByTagName("din5").item(0).getTextContent());
	         configuration.setDin6(outFilesElem.getElementsByTagName("din6").item(0).getTextContent());
	         
	         configuration.setSta1(outFilesElem.getElementsByTagName("sta1").item(0).getTextContent());
	         configuration.setSta2(outFilesElem.getElementsByTagName("sta2").item(0).getTextContent());
	         configuration.setSta3(outFilesElem.getElementsByTagName("sta3").item(0).getTextContent());
	         configuration.setSta4(outFilesElem.getElementsByTagName("sta4").item(0).getTextContent());
	         configuration.setSta5(outFilesElem.getElementsByTagName("sta5").item(0).getTextContent());
   ...
   public static boolean exportConfig(File file, ConfigurationModel configuration) {
	   try {
		   ...
		   DocumentBuilderFactory docFactory = DocumentBuilderFactory.newInstance();
			...
			Element inputFile3 = doc.createElement("inputFile3");
			inputFile3.appendChild(doc.createTextNode(configuration.getInputFile3()));
			inputFiles.appendChild(inputFile3);
