...
public class InputFileSettingsController {
	...
	public void setConfiguration(ConfigurationModel configuration) {
		...
		inputFile3Name.setText(configuration.getInputFile3());
	}
	...
	public void handleInFile3BrowseButton() { handleBrowseButton("inputFile3"); }
        ...
        if (file != null) {
           ...
           // String filename = parts[parts.length - 1];
            ...
            case "inputFile2":
            	...
            	break;
            case "inputFile3":
            	inputFile3Name.setText(filename);
            	break;
            }
        }
	}
	...
	private void save() {	
		...
		if(!inputFile3Name.getText().isEmpty()) { configuration.setInputFile3(inputFile3Name.getText()); }
