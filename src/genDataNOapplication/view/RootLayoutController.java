...
public class RootLayoutController {
    ...
    private void handleAbout() {
    	...
    	alert.setHeaderText("A synthetic data generator for online social network graphs");
    	alert.setContentText("Medici v2.0 - release Jan. 2021.\n©2018-2021 David Nettleton, Sergio Nettleton, Marc Canal (GUI)");
		Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
		Image icon = new Image("file:./resources/icons/info_icon.png");
		stage.getIcons().add(icon);		
		alert.setGraphic(new ImageView(icon));
	...
	@FXML
	public void handleSwitchResultsPublications() {
